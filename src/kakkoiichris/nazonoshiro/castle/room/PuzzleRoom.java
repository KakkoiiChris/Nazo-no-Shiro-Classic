...
public class PuzzleRoom extends Room {
    ...
    public PuzzleRoom(String name, int floor, int row, int column, int key, int lock, boolean locked, Puzzle puzzle) {
    ...
    public PuzzleRoom(String name, int floor, int row, int column, int key, int lock, boolean locked) {
        super(name, floor, row, column, key, lock, locked);
